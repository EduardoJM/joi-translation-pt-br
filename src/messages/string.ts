const messages = {
    ...
    'string.empty': '{{#label}} não deve ser vázio',
    'string.guid': '{{#label}} deve ser um GUID válido',
    'string.hex': '{{#label}} deve conter apenas carácteres hexadecimais',
    ...
    'string.lowercase': '{{#label}} deve conter apenas caracteres mínusculos',
    ...
    'string.uppercase': '{{#label}} deve conter apenas caracteres maiusculos',
}
